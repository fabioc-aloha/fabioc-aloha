...
- [empirical-validation.instructions.md] (Critical, Validates, Bidirectional) - "Research validation ensures documentation accuracy"
- [alex-core.instructions.md] (Critical, Enables, Forward) - "Core cognitive architecture integration"
- [bootstrap-learning.instructions.md] (High, Guides, Bidirectional) - "Domain learning documentation patterns"
