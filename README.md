...
| 🔒 [AlexFleetPortfolio](https://github.com/fabioc-aloha/AlexFleetPortfolio) 🤖 | Build engine for an AI-narrated GitHub profile: classifies, clusters, narrates, and Responsible-AI reviews 100+ repositories into a self-updating dashboard, then publishes to a lean profile repo. | Aug 2, 2026 |
...
| 📂 [Alex_ACT_Core](https://github.com/fabioc-aloha/Alex_ACT_Core) 🤖 | Plugin-native baseline brain for Alex ACT, with critical-thinking instructions, reusable agent skills, prompts, and tooling for GitHub Copilot. | Aug 2, 2026 |
| 🔒 [Alex_ACT_Memory](https://github.com/fabioc-aloha/Alex_ACT_Memory) | Shared memory bus for ACT-Edition heirs (peer-to-peer) | Aug 2, 2026 |
| 📂 [alex-act-enterprise](https://github.com/fabioc-aloha/alex-act-enterprise) 🤖 | Alex ACT config-template plugin for the public Microsoft ecosystem: Azure, Fabric, Power BI, M365 Agents Toolkit. Ships a setup-enterprise-stack skill that generates the ~/.copilot/settings.json block for 7 public plugins. Composes with alex-act-core and alex-act-illustrator-plugin. Maintained by Alex_ACT_Steward. | Aug 2, 2026 |
| 🔒 [alex-act-msft](https://github.com/fabioc-aloha/alex-act-msft) 🤖 | Alex ACT plugin for Microsoft-internal work. Agency project framework + setup-msft-stack scaffolding for WorkIQ, WorkIQ Productivity, org-report. Requires Microsoft corporate network. NOT for public Mall - private plugin only. Maintained by Alex_ACT_Steward. | Aug 2, 2026 |
...
| Repo | Description | Updated |
|------|-------------|---------|
| 📂 [Alex_ACT_Illustrator_Plugin](https://github.com/fabioc-aloha/Alex_ACT_Illustrator_Plugin) 🤖 | Alex - ACT Edition plugin: pick the right chart, then render it locally via the microsoft/flint-chart MCP server (Vega-Lite / ECharts / Chart.js). | Aug 2, 2026 |
...
| 🔒 [Big-Idea](https://github.com/fabioc-aloha/Big-Idea) 🤖 | — | Aug 2, 2026 |
