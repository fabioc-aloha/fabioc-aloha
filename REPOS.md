...
> **Last Updated**: February 05, 2026 at 06:29 AM UTC

> **Fabio Correa's GitHub Repository Collection**
> Comprehensive overview of 79 projects spanning AI research, academic tools, business intelligence, and cognitive architectures.
>
> **🏠 Original Work (70 repos)** | **🍴 Community Contributions (9 forks)** | **🔒 Private (37)** | **🌐 Public (42)**
...
| [**Alex_Plug_In**](https://github.com/fabioc-aloha/Alex_Plug_In) | 🌟 Public | TypeScript | Transform GitHub Copilot into a sophisticated AI learning partner with meta-cognitive awareness, persistent memory, dual-mind processing, and cross-project knowledge sharing. VS Code extension. | Feb 05, 2026 |
...
| [**fabioc-aloha**](https://github.com/fabioc-aloha/fabioc-aloha) | 🌟 Public | PowerShell | AI portfolio showcasing ethical human-AI collaboration. Think. Build. Deploy. | Feb 04, 2026 |
...
| [**Lithium**](https://github.com/fabioc-aloha/Lithium) | 🌟 Public | - | Systematic evidence review of lithium supplementation for Alzheimer's disease prevention - literature synthesis and meta-analysis framework | Feb 05, 2026 |
...
```mermaid
pie title Programming Languages (79 Repos)
    "PowerShell" : 20
    "Python" : 15
    "TypeScript" : 9
    "Jupyter Notebook" : 7
...
- **PowerShell (25.3%)**: Primary language for 20 repositories
- **Python (19%)**: Primary language for 15 repositories
- **TypeScript (11.4%)**: Primary language for 9 repositories
- **Jupyter Notebook (8.9%)**: Primary language for 7 repositories
- **C# (5.1%)**: Primary language for 4 repositories
