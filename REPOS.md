...
> **Last Updated**: November 03, 2025 at 06:13 AM UTC
...
| [**fabioc-aloha**](https://github.com/fabioc-aloha/fabioc-aloha) | 🌟 Public | PowerShell | Hands-free, daily self-updating AI & academic tooling portfolio (PowerShell + GitHub Actions). | Nov 02, 2025 |
...
| [**QualticsDashboard**](https://github.com/fabioc-aloha/QualticsDashboard) | 🔒 Private | C# | Real-time Qualtrics survey analytics dashboard with Azure integration. Phase 1 complete: API-hosted webhook receiver, background worker, Cosmos DB storage, 10 REST endpoints. Phase 2: SignalR real-time engine + React frontend. | Nov 02, 2025 |
