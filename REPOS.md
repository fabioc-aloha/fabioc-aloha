...
> **Last Updated**: January 20, 2026 at 06:15 AM UTC

> **Fabio Correa's GitHub Repository Collection**
> Comprehensive overview of 66 projects spanning AI research, academic tools, business intelligence, and cognitive architectures.
>
> **🏠 Original Work (58 repos)** | **🍴 Community Contributions (8 forks)** | **🔒 Private (31)** | **🌐 Public (35)**
...
| [**airs-enterprise**](https://github.com/fabioc-aloha/airs-enterprise) | 🔒 Private | TypeScript | Enterprise platform for the AIRS-16 psychometric instrument - measuring AI readiness through validated behavioral constructs. Built with Next.js, Azure, and research-backed methodology (N=523). | Jan 18, 2026 |
...
| [**CorreaX**](https://github.com/fabioc-aloha/CorreaX) | 🔒 Private | TypeScript | Azure & M365 management portal - React 19, TypeScript 5.9, Vite 7, Tailwind 4 | Jan 14, 2026 |
...
| [**fabioc-aloha**](https://github.com/fabioc-aloha/fabioc-aloha) | 🌟 Public | PowerShell | AI portfolio showcasing ethical human-AI collaboration. Think. Build. Deploy. | Jan 19, 2026 |
...
```mermaid
pie title Programming Languages (66 Repos)
    "PowerShell" : 18
    "Python" : 13
    "Jupyter Notebook" : 7
    "TypeScript" : 6
...
- **PowerShell (27.3%)**: Primary language for 18 repositories
- **Python (19.7%)**: Primary language for 13 repositories
- **Jupyter Notebook (10.6%)**: Primary language for 7 repositories
- **TypeScript (9.1%)**: Primary language for 6 repositories
- **C# (7.6%)**: Primary language for 5 repositories
