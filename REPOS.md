...
> **Last Updated**: February 27, 2026 at 06:26 AM UTC

> **Fabio Correa's GitHub Repository Collection**
> Comprehensive overview of 112 projects spanning AI research, academic tools, business intelligence, and cognitive architectures.
>
> **🏠 Original Work (88 repos)** | **🍴 Community Contributions (24 forks)** | **🔒 Private (48)** | **🌐 Public (64)**
...
|------------|------------|----------|-------------|--------------|
| [**AcademicPublications**](https://github.com/fabioc-aloha/AcademicPublications) | 🔒 Private | SCSS | - | Feb 21, 2026 |
...
| [**ai-wallpaper-generator**](https://github.com/fabioc-aloha/ai-wallpaper-generator) | 🌟 Public | JavaScript | AI-powered wallpaper generator PWA optimized for iPhone 16 Pro using Azure serverless and Replicate AI | Feb 21, 2026 |
...
| [**Alex_Plug_In**](https://github.com/fabioc-aloha/Alex_Plug_In) | 🌟 Public | TypeScript | Transform GitHub Copilot into a sophisticated AI learning partner with meta-cognitive awareness, persistent memory, dual-mind processing, and cross-project knowledge sharing. VS Code extension. | Feb 27, 2026 |
...
| [**Alex-Global-Knowledge**](https://github.com/fabioc-aloha/Alex-Global-Knowledge) | 🔒 Private | PowerShell | Alex Cognitive Architecture - Global Knowledge Base | Feb 27, 2026 |
...
| [**AlexBooks**](https://github.com/fabioc-aloha/AlexBooks) | 🔒 Private | JavaScript | - | Feb 25, 2026 |
...
| [**AlexPapers**](https://github.com/fabioc-aloha/AlexPapers) | 🔒 Private | Rich Text Format | Academic papers, research, and derivative works from the Alex Cognitive Architecture project | Feb 25, 2026 |
...
| [**ChessCoach**](https://github.com/fabioc-aloha/ChessCoach) | 🔒 Private | Python | AI-powered chess coaching platform with dual-engine analysis (Stockfish + Maia-2), Azure OpenAI coaching, and real-time game analysis | Feb 09, 2026 |
...
| [**Extensions**](https://github.com/fabioc-aloha/Extensions) | 🌟 Public | TypeScript | Monorepo of 16 VS Code productivity extensions — focus timer, markdown to Word, AI voice reader, secret guard, MCP starter, workspace watchdog, and more. | Feb 25, 2026 |
| [**fabioc-aloha**](https://github.com/fabioc-aloha/fabioc-aloha) | 🌟 Public | PowerShell | AI portfolio showcasing ethical human-AI collaboration. Think. Build. Deploy. | Feb 26, 2026 |
...
| [**FishbowlGovernance**](https://github.com/fabioc-aloha/FishbowlGovernance) | 🔒 Private | HTML | Microsoft Fabric governance documentation and monitoring system for Fishbowl workspace - medallion architecture, permission compliance pipelines, workspace inventory | Feb 26, 2026 |
...
| [**ideas**](https://github.com/fabioc-aloha/ideas) | 🔒 Private | - | Project plans, ideas, and Alex cognitive architecture domain knowledge | Dec 23, 2025 |
...
| [**WindowsWidget**](https://github.com/fabioc-aloha/WindowsWidget) | 🌟 Public | C# | Windows 11 Widget Provider using Windows App SDK, Adaptive Cards, and IWidgetProvider interface for the Widgets Board | Feb 05, 2026 |
...
| [**youtube-mcp-server**](https://github.com/fabioc-aloha/youtube-mcp-server) | 🌟 Public | TypeScript | Comprehensive YouTube MCP Server with 31 tools, AI intelligence layer, learning path generator, content repurposing, and watch history analysis | Jan 27, 2026 |
| [**youtube-mcp-vscode**](https://github.com/fabioc-aloha/youtube-mcp-vscode) | 🌟 Public | TypeScript | Self-sufficient VS Code extension for YouTube video intelligence - search, analyze, transcripts, flashcards. Zero external dependencies. | Jan 27, 2026 |
...
| [**agentic-coding-impact**](https://github.com/fabioc-aloha/agentic-coding-impact) | 🌟 Public | - | Replication package for MSR ’26: "AI IDEs or Autonomous Agents? Measuring the Impact of Coding Agents on Software Development" | Feb 21, 2026 |
| [**ASI-Arch**](https://github.com/fabioc-aloha/ASI-Arch) | 🌟 Public | - | AlphaGo Moment for Model Architecture Discovery. | Aug 01, 2025 |
| [**awesome-zeppos**](https://github.com/fabioc-aloha/awesome-zeppos) | 🌟 Public | - | ⭐ Useful resources for the Zepp OS | Feb 20, 2026 |
...
| [**codespace-features**](https://github.com/fabioc-aloha/codespace-features) | 🌟 Public | - | Devcontainer features for use in Codespaces | Feb 13, 2026 |
| [**dorita980**](https://github.com/fabioc-aloha/dorita980) | 🌟 Public | JavaScript | Unofficial iRobot Roomba and Braava (i7/i7+, 980, 960, 900, e5, 690, 675, m6, etc) node.js library (SDK) to control your robot | Feb 10, 2026 |
| [**gastown**](https://github.com/fabioc-aloha/gastown) | 🌟 Public | - | Gas Town - multi-agent workspace manager | Feb 04, 2026 |
...
| [**spec-kit**](https://github.com/fabioc-aloha/spec-kit) | 🌟 Public | - | Toolkit to help you get started with Spec-Driven Development | Feb 18, 2026 |
| [**vscode**](https://github.com/fabioc-aloha/vscode) | 🌟 Public | - | Visual Studio Code | Feb 06, 2026 |
| [**ZeppOS-App-WorkFlow-Demo**](https://github.com/fabioc-aloha/ZeppOS-App-WorkFlow-Demo) | 🌟 Public | - | - | Feb 20, 2026 |
| [**zeppos-docs**](https://github.com/fabioc-aloha/zeppos-docs) | 🌟 Public | - | https://docs.zepp.com/ | Feb 20, 2026 |
| [**zeppos-DreamCapsule**](https://github.com/fabioc-aloha/zeppos-DreamCapsule) | 🌟 Public | - | - | Feb 20, 2026 |
| [**zeppos-fx**](https://github.com/fabioc-aloha/zeppos-fx) | 🌟 Public | - | A library for building advanced animations in ZeppOS. 一个用于在ZeppOS中制作进阶动画的库 | Feb 20, 2026 |
| [**zeppos-github-widget**](https://github.com/fabioc-aloha/zeppos-github-widget) | 🌟 Public | - | - | Feb 20, 2026 |
| [**zeppos-input-method**](https://github.com/fabioc-aloha/zeppos-input-method) | 🌟 Public | - | - | Feb 20, 2026 |
| [**zeppos-reactive**](https://github.com/fabioc-aloha/zeppos-reactive) | 🌟 Public | - | An extremely lightweight reactive system designed for performance-constrained JavaScript environments. | Feb 20, 2026 |
| [**zeppos-reactive-ui**](https://github.com/fabioc-aloha/zeppos-reactive-ui) | 🌟 Public | - | - | Feb 20, 2026 |
| [**zeppos-samples**](https://github.com/fabioc-aloha/zeppos-samples) | 🌟 Public | - | A collection of samples about Zepp OS watchfaces and applications | Feb 20, 2026 |

---

## 🏠 Original Work vs 🍴 Community Contributions

### **🏠 Original Repositories (88)**
...
```mermaid
pie title Programming Languages (112 Repos)
    "PowerShell" : 20
    "Python" : 17
    "TypeScript" : 12
    "JavaScript" : 8
...
- **PowerShell (17.9%)**: Primary language for 20 repositories
- **Python (15.2%)**: Primary language for 17 repositories
- **TypeScript (10.7%)**: Primary language for 12 repositories
- **JavaScript (7.1%)**: Primary language for 8 repositories
- **Jupyter Notebook (7.1%)**: Primary language for 8 repositories
