...
> **Last Updated**: January 26, 2026 at 06:16 AM UTC

> **Fabio Correa's GitHub Repository Collection**
> Comprehensive overview of 70 projects spanning AI research, academic tools, business intelligence, and cognitive architectures.
>
> **🏠 Original Work (62 repos)** | **🍴 Community Contributions (8 forks)** | **🔒 Private (34)** | **🌐 Public (36)**
...
| [**Alex_Plug_In**](https://github.com/fabioc-aloha/Alex_Plug_In) | 🌟 Public | TypeScript | Transform GitHub Copilot into a sophisticated AI learning partner with meta-cognitive awareness, persistent memory, dual-mind processing, and cross-project knowledge sharing. VS Code extension. | Jan 25, 2026 |
| [**alex-articles**](https://github.com/fabioc-aloha/alex-articles) | 🔒 Private | Python | Academic publications & research for the Alex Cognitive Architecture — a biologically-inspired framework giving AI coding assistants persistent memory, synaptic networks, and dream states | Jan 25, 2026 |
...
| [**ChessCoach**](https://github.com/fabioc-aloha/ChessCoach) | 🔒 Private | Python | AI-powered chess coaching platform with dual-engine analysis (Stockfish + Maia-2), Azure OpenAI coaching, and real-time game analysis | Jan 26, 2026 |
...
| [**CorreaX**](https://github.com/fabioc-aloha/CorreaX) | 🔒 Private | TypeScript | Azure & M365 management portal - React 19, TypeScript 5.9, Vite 7, Tailwind 4 | Jan 24, 2026 |
...
| [**cpesynapse_workspace**](https://github.com/fabioc-aloha/cpesynapse_workspace) | 🔒 Private | PowerShell | - | Jan 26, 2026 |
...
| [**fabioc-aloha**](https://github.com/fabioc-aloha/fabioc-aloha) | 🌟 Public | PowerShell | AI portfolio showcasing ethical human-AI collaboration. Think. Build. Deploy. | Jan 25, 2026 |
...
| [**spotify-skill**](https://github.com/fabioc-aloha/spotify-skill) | 🌟 Public | Python | Spotify Skills for Claude - Production Spotify API integration + complete toolkit for creating Claude Desktop Skills. Includes OAuth 2.0, cover art generation, automated tools, and comprehensive guides. | Jan 19, 2026 |
...
| [**youtube-mcp-server**](https://github.com/fabioc-aloha/youtube-mcp-server) | 🌟 Public | TypeScript | Intelligent MCP server that transforms YouTube into a knowledge engine for AI agents. Multi-video research synthesis, concept extraction, smart transcript chunking, and 26 powerful tools. | Jan 26, 2026 |
...
```mermaid
pie title Programming Languages (70 Repos)
    "PowerShell" : 19
    "Python" : 14
    "Jupyter Notebook" : 7
    "TypeScript" : 7
...
- **PowerShell (27.1%)**: Primary language for 19 repositories
- **Python (20%)**: Primary language for 14 repositories
- **Jupyter Notebook (10%)**: Primary language for 7 repositories
- **TypeScript (10%)**: Primary language for 7 repositories
- **C# (7.1%)**: Primary language for 5 repositories
