...
> **Last Updated**: February 09, 2026 at 06:34 AM UTC

> **Fabio Correa's GitHub Repository Collection**
> Comprehensive overview of 84 projects spanning AI research, academic tools, business intelligence, and cognitive architectures.
>
> **🏠 Original Work (74 repos)** | **🍴 Community Contributions (10 forks)** | **🔒 Private (39)** | **🌐 Public (45)**
...
| [**fabioc-aloha**](https://github.com/fabioc-aloha/fabioc-aloha) | 🌟 Public | PowerShell | AI portfolio showcasing ethical human-AI collaboration. Think. Build. Deploy. | Feb 08, 2026 |
...
| [**roomba-control**](https://github.com/fabioc-aloha/roomba-control) | 🔒 Private | TypeScript | - | Feb 08, 2026 |
...
```mermaid
pie title Programming Languages (84 Repos)
    "PowerShell" : 20
    "Python" : 15
    "TypeScript" : 10
    "Jupyter Notebook" : 7
...
- **PowerShell (23.8%)**: Primary language for 20 repositories
- **Python (17.9%)**: Primary language for 15 repositories
- **TypeScript (11.9%)**: Primary language for 10 repositories
- **Jupyter Notebook (8.3%)**: Primary language for 7 repositories
